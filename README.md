...
This package already contains some functionality as of 3.x, including autocompletion, navigation, tooltips, signature help (call tips) and linting. Over time, all official add-on packages will be made redundant by reimplementation in the core. The following packages currently still need to be installed as add-on if you desire this functionality:
