    ...
    Proxy = class Proxy {
        ...
        */
        spawnPhpServer(port) {
            ...
            const parameters = [
                ...
                this.phpInvoker.normalizePlatformAndRuntimePath(this.corePath) + '/src/Main.php',
            ...
            const process = this.phpInvoker.invoke(parameters, additionalDockerRunParameters);
        ...
        */
        getNamespaceList() {
            ...
            return this.performRequest('namespaceList', parameters);
        }
