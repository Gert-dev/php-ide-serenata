...
`;
    ...
    */
    activateAnnotations() {
        ...
        return Array.from(this.annotationProviders).map((provider) =>
    ...
    */
    deactivateAnnotations() {
        for (let provider of Array.from(this.annotationProviders)) {
            provider.deactivate();
        }
    ...
    */
    activateRefactoring() {
        ...
        return Array.from(this.getRefactoringProviders()).map((provider) =>
            provider.activate(this.getService()));
    },
