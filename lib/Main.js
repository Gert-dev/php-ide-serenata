...
regarding member overrides and interface implementations.`,
        ...
        linting: {
            ...
            properties: {
                enable: {
                    title       : 'Enable',
                    description : 'When enabled, linting will show syntax errors in your code. ' +
                        'Looking for the old linting options? Serenata 5 has removed them in favor of existing ' +
                        'alternatives, which do a much better job at this. See also ' +
                        'https://gitlab.com/Serenata/Serenata/wikis/Linting for more information.',
                    type        : 'boolean',
                    default     : true,
                    order       : 1
                }
