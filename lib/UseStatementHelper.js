        ...
        */
        scoreClassName(firstClassName, secondClassName) {
            ...
            if (firstClassNameParts.length !== secondClassNameParts.length) {
                if (firstClassNameParts.length <= 2) {
                    return -1;
                } else if (secondClassNameParts.length <= 2) {
                    return 1;
                }
            }
            ...
            throw new Error(
                'Should never be reached as it would mean specified class names are identical, which should have ' +
                'been handled early'
            );
        }
