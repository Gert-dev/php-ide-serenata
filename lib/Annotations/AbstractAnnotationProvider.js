        ...
        */
        registerEvents(editor) {
            ...
            editor.onDidStopChanging(() => {
                // This should normally happen when indexing completes, so this poor workaround only exists as band-aid
                // until this is moved to the server and not worth investigating too much additional time in.
                setTimeout(() => {
                    this.rescan(editor);
                }, 3000);
