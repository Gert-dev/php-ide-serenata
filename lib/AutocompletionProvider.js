    ...
    AbstractProvider = class AbstractProvider {
        ...
        */
        registerEventsForPane(pane) {
            return (() => {
                const result = [];
                for (let paneItem of Array.from(pane.items)) {
        ...
        */
        getSuggestionLeftLabel(suggestion) {
            ...
            } else if ((suggestion.extraData != null ? suggestion.extraData.protectionLevel : undefined) === 'protecetd') {
        ...
        */
        onDidInsertSuggestion({editor, triggerPosition, suggestion}) {
            ...
            return editor.transact(() => {
                return Array.from(suggestion.extraData.additionalTextEdits).map((additionalTextEdit) =>
