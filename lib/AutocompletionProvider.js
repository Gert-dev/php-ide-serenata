...
const LanguageClientAutocompleteAdapter = require(
...
(AbstractProvider = (function() {
    AbstractProvider = class AbstractProvider {
        ...
        */
        getSuggestions({editor, bufferPosition, scopeDescriptor, prefix}) {
            ...
            const successHandler = suggestions => {
                return suggestions.map(suggestion => {
                    return this.getAdaptedSuggestion(suggestion, editor);
                });
            };
         ...
         * @return {Array}
        */
        getAdaptedSuggestion(suggestion, editor) {
            const adaptedSuggestion = {
                ...
                rightLabel         : suggestion.detail,
                description        : suggestion.documentation,
                className          : `php-ide-serenata-autocompletion-suggestion${suggestion.deprecated ? ' php-ide-serenata-autocompletion-strike' : ''}`,
            ...
            if (suggestion.textEdit) {
                LanguageClientAutocompleteAdapter.applyTextEditToSuggestion(
                    suggestion.textEdit,
                    editor,
                    adaptedSuggestion
                );
            ...
            // TODO: Better would be to support the textEdit property sent back by the core's suggestions via
