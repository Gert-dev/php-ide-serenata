...
class ExtractMethodView extends View {
    ...
    static content() {
        return this.div({class: 'php-ide-serenata-refactoring-extract-method'}, () => {
            this.div({outlet: 'methodNameForm'}, () => {
                this.subview('methodNameEditor', new TextEditorView(
                    { mini: true, placeholderText: 'Enter a method name' }
                ));
                this.div(
                    { class: 'text-error error-message hide error-message--method-name' },
                    'You must enter a method name!'
                );
                            ...
                            return this.label({class: 'control-label'}, () => {
                                ...
                                return this.div({class: 'controls generate-docs-control'}, () => {
                                    return this.div({class: 'checkbox'}, () => {
                                        return this.label(() => {
                                            this.input({
                                                outlet: 'generateDescPlaceholdersInput',
                                                type: 'checkbox'
                                            });
                                            return this.div(
                                                { class: 'setting-title' },
                                ...
                                return this.div({class: 'controls'}, () => {
                                    return this.div({class: 'checkbox'}, () => {
                                        return this.label(() => {
                                            ...
                                            return this.div(
                                                { class: 'setting-title' },
                                                'Use PHP 5.4 array syntax (square brackets)'
                                            );
                                        });
                                    });
                                });
    ...
    */
    initialize() {
        ...
        $(this.generateDocInput[0]).change(() => {
