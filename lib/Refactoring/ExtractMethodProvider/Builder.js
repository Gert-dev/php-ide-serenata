...
class Builder {
    ...
    */
    setService(service) {
        ...
        this.parameterParser.setService(service);
    }
    ...
    */
    setSelectedBufferRange(range) {
        this.selectedBufferRange = range;
    }
    ...
    */
    setEditor(editor) {
        ...
        this.setSelectedBufferRange(editor.getSelectedBufferRange());
    }
    ...
    */
    buildMethod(settings) {
        ...
        return this.parameterParser.findParameters(this.editor, this.selectedBufferRange)
