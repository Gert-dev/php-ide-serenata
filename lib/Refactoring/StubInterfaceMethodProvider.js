    ...
    */
    constructor(docblockBuilder, functionBuilder) {
        ...
        */
         ...
         * @type {Object}
        */
        this.prototype.docblockBuilder = docblockBuilder;

        /**
         * @type {Object}
        */
        this.prototype.functionBuilder = functionBuilder;
    }
        ...
        const successHandler = currentClassName => {
            ...
            const nestedSuccessHandler = classInfo => {
                ...
                for (let name in classInfo.methods) {
                    ...
                    if (
                        (method.declaringStructure.type === 'interface') &&
                        ((method.implementations != null ? method.implementations.length : undefined) === 0)
                    ) {
                        items.push(data);
                    }
                }
